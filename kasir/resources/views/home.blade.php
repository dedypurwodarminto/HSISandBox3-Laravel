    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="#" aria-expanded="false">
                            <i class="icon-badge menu-icon"></i><span class="nav-text">Setelan Diskon</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#" aria-expanded="false">
                            <i class="icon-badge menu-icon"></i><span class="nav-text">Transaksi</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" aria-expanded="false">
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright &copy; Designed & Developed by <a href="#">ARN211-48120</a>2024</p>
            </div>
        </div>
        <!--**********************************
            Footer end
